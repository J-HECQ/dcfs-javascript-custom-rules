...
@Rule(
  ...
  name = "Datagrid operate : datagrid。Cells(r,1) , Const variable should not be used.",
  tags = {"convention"}
...
public class DataGridCellsOperateCheck extends DoubleDispatchVisitorCheck {
  ...
  private static final Set<String> FORBIDDEN_FUNCTIONS = ImmutableSet.of("cells");
  ...
  public void visitCallExpression(CallExpressionTree tree) {
    ...
    if (callee.is(Kind.DOT_MEMBER_EXPRESSION) && FORBIDDEN_FUNCTIONS.contains(((IdentifierTree) callee.property()).name())) {
